				...
				<div class="modal-body">
					<div class="card-body">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="kode_kelas" name="kode_kelas" placeholder="masukan kode kelas" onchange="remove(id)">
						</div>
						<div class="form-group">
							<label>Nama Kelas: <span class='text-danger'>*</span></label>
							<input type="text" class="form-control" id="nama_kelas" name="nama_kelas" placeholder="masukan nama kelas" onchange="remove(id)">
						</div>
						<div class="form-group">
