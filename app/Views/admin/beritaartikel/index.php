				...
				<div class="modal-body">
					<div class="card-body">
						<div class="form-group">
							...
							<select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" id="tipe" name="tipe" data-allow-clear="true" style="width:100%">
						...
						<div class="form-group">
							...
							<img id="preview-banner" class="img-fluid mt-2" style="max-height: 150px;">
						</div>
					</div>
				</div>
